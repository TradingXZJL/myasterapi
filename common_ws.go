...
const (
	ASTER_API_SPOT_WS_STREAM        = "sstream.asterdex.com"
	ASTER_API_FUTURE_WS_STREAM      = "fstream.asterdex.com"
	ASTER_API_FUTURE_WS_STREAM_GZIP = "sfstream.asterdex.com"

	ASTER_API_SPOT_WS_API   = "ws-api.asterdex.com:9443"
	ASTER_API_FUTURE_WS_API = "ws-fapi.asterdex.com"
)
...
func getWsStreamWsApi(apiType ApiType, isGzip bool) string {
	...
	case SPOT:
		switch NowNetType {
		case MAIN_NET:
			return ASTER_API_SPOT_WS_STREAM
		}
	case FUTURE:
		switch NowNetType {
		case MAIN_NET:
			if isGzip {
				return ASTER_API_FUTURE_WS_STREAM_GZIP
			} else {
				return ASTER_API_FUTURE_WS_STREAM
			}
		}
	}
	return ""
...
func getWsApiWsApi(apiType ApiType) string {
	...
	case SPOT:
		switch NowNetType {
		case MAIN_NET:
			return ASTER_API_SPOT_WS_API
		}
	case FUTURE:
		switch NowNetType {
		case MAIN_NET:
			return ASTER_API_FUTURE_WS_API
		}
	}
