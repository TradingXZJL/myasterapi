...
type AsterErrorRes struct {
	Code interface{} `json:"code"`
	Msg  string      `json:"msg"`
}

type AsterRestRes[T any] struct {
	Result        T //请求结果
	AsterErrorRes   //错误信息
}

func handlerCommonRest[T any](data []byte) (*AsterRestRes[T], error) {
	res := &AsterRestRes[T]{}
	var err error
...
func (err *AsterErrorRes) handlerError() error {
